...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("IsoTiles", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height), 1.0f);
#else
        glview = GLViewImpl::create("IsoTiles");
#endif
